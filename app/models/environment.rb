...
class Environment < ActiveRecord::Base
  ...
  settings_items :description, :type => String, :default => '<div style="text-align: center"><a href="http://noosfero.org/"><img src="/images/noosfero-network.png" alt="Participe em Rede!"/></a></div>'
